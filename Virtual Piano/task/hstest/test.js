...
async function stageTest() {
    ...
    let result = await hs.testPage(page,
        ...
        // Test #7 - Test that only one instance of each button
        () => {
        ...
        // Test #8 - Test if all elements have the same top y-coordinate
        ...
        // Test #18 - Test if there is enough space between E and T keyboards
        () => {
            let buttons = document.querySelectorAll('kbd');
